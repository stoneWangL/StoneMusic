...
public class OnlineMusicListActivity extends BaseActivity
    ...
    public void initMusicPlayImg() {
        ...
        try {
            ...
            if (MediaUtils.musicType == PlayType.OnlineType) { //当前为播放在线歌曲状态
    ...
    public void loadSuccess() {
        ...
        listAdapter = new OnlineMusicListAdapter(musicList,this,R.layout.item_music);
    ...
    public void onItemClick(View v, int position) {
        ...
        if (position == lastPosition && null != jumpToOtherWhere) //点击的是正在播放的歌曲
            ...
            MediaUtils.musicType = PlayType.OnlineType;
